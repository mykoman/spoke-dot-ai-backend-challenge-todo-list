...
todoRouter.post("/", [verifyToken, validate(validateTodoCreation)], asyncWrapper(createTodo));
todoRouter.get("/", asyncWrapper(listTodos));
todoRouter.patch("/:id", [verifyToken, validate(validateTodoUpdate)], asyncWrapper(updateTodo));
